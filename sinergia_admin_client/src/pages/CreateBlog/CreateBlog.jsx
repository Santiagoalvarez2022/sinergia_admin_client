...
import SelectCategorie from './ui/SelectCategories';
import SelectCategories from './ui/SelectCategories';


const validateErrors = ({title,text,author,design_type,image,approved, tags}) =>{
  
  let error = {}
  if (!title || !text || !author || !design_type || !image || !approved || !tags.length) {
...
export default function CreateBlog() {
  ...
  const handlerForm = ({target}) =>{
    console.log('entre al handler form ', target);
    ...
    return (
      <div className='min-h-screen flex justify-center items-center '>
        <div className='flex flex-col justify-center items-center gap-2 border p-4 rounded-xl'> 
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="green" strokeWidth="2" strokeLinecap="round" strokelinejoin="round" className="lucide lucide-circle-check-big-icon lucide-circle-check-big"><path d="M21.801 10A10 10 0 1 1 17 3.335"/><path d="m9 11 3 3L22 4"/></svg>
  ...
  return (
    <div className='min-h-screen flex justify-center items-start  px-4 bg-bg '>
      <div className='mt-10 flex flex-col shadow-md shadow-black/20 flex items-start justify-center w-full rounded-md px-4 pb-4  md:w-[50%] lg:w-[30%]'>
        ...
        <div className=''>
          <h3>Seleciona un diseño</h3>
          <select name="design_type" onChange={handlerForm} id="" className='mb-4 text-end pr-4'>
